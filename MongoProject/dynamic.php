...
<html lang="en">
  <head>
    ...
    <title>Dynamic Schema · FrontEnd NoSQL</title>
...
<br>
Click below to use projections in MongoDB via php.
<br>
</p>
<p align='center'>
<a class="btn btn-lg btn-primary" href="projections.php" role="button"> P R O J E C T I O N S </a>
</p>
</div>
</main>
<main role="main" class="container">
...
<?php
    ...
    $rows = $manager->executeQuery('a.dynamic', $query);

     echo "<p align='center'>";

    foreach($rows as $row){
    $bson = MongoDB\BSON\fromPHP($row);
    echo MongoDB\BSON\toJSON($bson), "<br> <br>";
    }
    echo "</p>";
