...
<html lang="en">
  <head>
    ...
    <title>UPDATE · FrontEnd NoSQL</title>
...
<main role="main" class="container">
  <div class="jumbotron">
    <h1 align='center'> U P D A T E </h1>
    <p align='center' class="lead">
    <br>
    There should be a function to call when information about a document must be changed.
     The program calling the function would supply the new values for 
     “firstname”, “lastname”, and other fields. 
     After the function call, 
     the corresponding document selected on the basis of a filter in the collection would contain the new values for each key supplied.
    <br>
    <br>
    Sharing two snapshots of my own 'UPDATE' code
    <br>
    <br>
    <img src="update2.png">
    <br>
