...
<html lang="en">
  <head>
    ...
    <title>READ · FrontEnd NoSQL</title>
...
<main role="main" class="container">
  <div class="jumbotron">
    <h1 align='center'> R E A D </h1>
    <p align='center' class="lead">
    <br>
    This would consist of a function which would be called to see all
     of the data currently in the collection. 
     This function call would not alter the data in the collection - 
     it would simply retrieve the resource and display the results. 
     We also have a function to retrieve a single document via the $filter query option , for which we could supply the firstname,
      lastname, or number. Again, this document would not be modified, only retrieved.
    <br>
    <br>
    Sharing two versions of my own 'READ' code
    <br>
    <br>
    <img src="read1.png">
    <br>
