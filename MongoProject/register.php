...
<html lang="en">
  <head>
    ...
    <title>Register · FrontEnd NoSQL</title>
...
<form class="form-signin" method="post" action="register.php">
  <div class="text-center ">
    <h1>FrontEnd MongoDB</h1>
    <h5>A DataBase Handler</h5>
    <br>
  ...
  <div class="form-label-group">
	...
	<div class="form-label-group">
    <input type="email" id="inputEmail" name="email"class="form-control" placeholder="Email ID" required >
    <label for="inputEmail">Email ID</label>
  </div>

  <div class="form-label-group">
    <input type="password" name="password_1" id="inputPassword_1" class="form-control" placeholder="Password" required>
    <label for="inputPassword_1">Password</label>
  </div>
	<div class="form-label-group">
    <input type="password" name="password_2" id="inputPassword_2" class="form-control" placeholder="Confirm Password" required>
    <label for="inputPassword_2">Confirm Password</label>
  </div>
