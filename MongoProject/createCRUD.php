...
<html lang="en">
  <head>
    ...
    <title>CREATE · FrontEnd NoSQL</title>
...
<main role="main" class="container">
  <div class="jumbotron">
    <h1 align='center'> C R E A T E </h1>
    <p align='center' class="lead">
    <br>
    This would consist of a function which we would
     call when a new document is being added to the collection. 
     The program calling the function would supply the values 
     for “firstname”, “lastname”, “city”,“number”, “branch”, “gender”, “resident”  . After this function is called, 
    ...
    <br>
    <br>
    Sharing the snapshot of my own 'CREATE' code
    <br>
    <br>
    <img src="create.png">
    </p>
